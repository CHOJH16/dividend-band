...
/*
 * 정확히 365일만 조회하면 배당락일이 며칠 이동했을 때
 * 분기배당 4회 중 한 번이 빠지는 문제가 생길 수 있습니다.
 *
 * 따라서 최대 400일 동안 배당 이벤트를 확인하고,
 * 월배당·분기배당·반기배당·연배당 빈도에 맞춰
 * 최근 지급 횟수만 합산합니다.
 */
...
/*
 * 검색 API가 반환한 종목만 표시합니다.
 *
 * 사용자가 APPLE처럼 잘못된 문자열을 입력했을 때
 * 그 문자열 자체를 티커로 간주하는
 * "Yahoo Finance 직접 조회" 항목은 생성하지 않습니다.
 */
